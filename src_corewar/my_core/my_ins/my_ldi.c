/*
** my_ldi.c for my_ldi in /home/plasko_a/rendu/CPE_2014_corewar/src_vm/my_core/my_ins
** 
** Made by Antoine Plaskowski
** Login   <antoine.plaskowski@epitech.eu>
** 
** Started on  Sun Apr 13 08:52:25 2014 Antoine Plaskowski
** Last update Sun Apr 13 22:23:03 2014 Antoine Plaskowski
*/
...
int		my_ldi(t_vm *vm, t_proc *proc, int opcode)
{
  ...
  if (my_load_in_mem(arg, proc, vm->mem, opcode))
    return (1);
  tmp = proc->pc;
  tmp += my_value_if_reg(&arg[0]) % IDX_MOD;
  tmp += my_value_if_reg(&arg[1]) % IDX_MOD;
