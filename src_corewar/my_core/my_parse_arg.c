/*
** my_parse_arg.c for my_parse_arg in /home/plasko_a/rendu/CPE_2014_corewar/src_vm
** 
** Made by Antoine Plaskowski
** Login   <antoine.plaskowski@epitech.eu>
** 
** Started on  Sun Apr 13 09:42:35 2014 Antoine Plaskowski
** Last update Sun Apr 13 20:13:18 2014 Antoine Plaskowski
*/
...
static int	my_check_type(t_arg *arg, char *mem, int tmp_pc)
{
  if (arg->type == T_REG)
    ...
    {
      arg->arg = my_read_oct_modulo(mem, tmp_pc, DIR_SIZE);
      tmp_pc += DIR_SIZE;
    }
  return (tmp_pc);
}
